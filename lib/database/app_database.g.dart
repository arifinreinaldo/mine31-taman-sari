...
class $ProductsTable extends Products with TableInfo<$ProductsTable, Product> {
  ...
  @override
  late final GeneratedColumn<int> suggestedPrice = GeneratedColumn<int>(
  ...
  Product map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Product(
      ...
      suggestedPrice: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}suggested_price'])!,
...
class Product extends DataClass implements Insertable<Product> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['suggested_price'] = Variable<int>(suggestedPrice);
  ...
  factory Product.fromJson(Map<String, dynamic> json,
    ...
    return Product(
      ...
      suggestedPrice: serializer.fromJson<int>(json['suggestedPrice']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'suggestedPrice': serializer.toJson<int>(suggestedPrice),
  ...
  @override
  int get hashCode => Object.hash(id, name, suggestedPrice, costPrice, stockQty,
...
class ProductsCompanion extends UpdateCompanion<Product> {
  ...
  final Value<int> suggestedPrice;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (suggestedPrice.present) {
      map['suggested_price'] = Variable<int>(suggestedPrice.value);
    }
...
class $TransactionsTable extends Transactions
  ...
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
      'id', aliasedName, false,
      type: DriftSqlType.string, requiredDuringInsert: true);
  static const VerificationMeta _dateTime_Meta =
      const VerificationMeta('dateTime_');
  @override
  ...
  Transaction map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Transaction(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}id'])!,
      dateTime_: attachedDatabase.typeMapping
...
class TransactionItem extends DataClass implements Insertable<TransactionItem> {
  ...
  int get hashCode => Object.hash(
      id, transactionId, productId, productName, quantity, unitPrice, subtotal);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  List<DatabaseSchemaEntity> get allSchemaEntities =>
      [products, transactions, transactionItems, syncMetadata];
}
...
class $$ProductsTableFilterComposer
  ...
  ColumnFilters<int> get suggestedPrice => $composableBuilder(
...
class $$ProductsTableOrderingComposer
  ...
  ColumnOrderings<int> get suggestedPrice => $composableBuilder(
      column: $table.suggestedPrice,
...
class $$ProductsTableAnnotationComposer
  ...
  GeneratedColumn<int> get suggestedPrice => $composableBuilder(
  ...
  $$ProductsTableTableManager(_$AppDatabase db, $ProductsTable table)
      : super(TableManagerState(
          ...
          updateCompanionCallback: ({
            ...
            Value<int> suggestedPrice = const Value.absent(),
...
class $$TransactionsTableFilterComposer
  ...
  ColumnFilters<DateTime> get dateTime_ => $composableBuilder(
      column: $table.dateTime_, builder: (column) => ColumnFilters(column));
...
class $$TransactionsTableOrderingComposer
  ...
  ColumnOrderings<DateTime> get dateTime_ => $composableBuilder(
      column: $table.dateTime_, builder: (column) => ColumnOrderings(column));
